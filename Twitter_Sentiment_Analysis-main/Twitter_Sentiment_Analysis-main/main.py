...
def sentiment():
    ...
    consumerKey = "YO6WLcQXccSxymt5ofXzgVW73"
    consumerSecret = "G6MNx4VYtGmbyooHIVqkO7pxMTMeLBtnHuoOf7xRbnIzX2h5Vn"
    accessToken = "1410039535153532933-kmOFBu6YiTLe9UPSiFMwqhG8xuUBaj"
    accessTokenSecret = "rY8tXIJgsIVnRfoJhRqDzWgz1YFLNS88sOuUc5QkEoQuK"
    ...
    if userid == "":
        ...
        post = api.user_timeline(screen_name=userid, count = 100, lang ="en", tweet_mode="extended")
